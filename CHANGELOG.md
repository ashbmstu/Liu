...
- **An application icon**: a U, for the third letter of Liu and for the
  cross-section of the crater a pulse leaves. `tools/make_icon.py` draws it, so
  it can be changed with a diff rather than replaced as a binary.
...
[1.0.2]: https://github.com/ashbmstu/Liu/releases/tag/v1.0.2
